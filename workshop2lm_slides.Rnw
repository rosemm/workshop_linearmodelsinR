...
\hwydt{Specify a model formula to test whether students' strength-training self-efficacy at post test (STSE1) can be predicted from whether they got the intervention, their pretest self-esteem (SE1), controlling for their pretest strength-training self-efficacy (STSE0)}
\pause
<<  >>=
...
library(car)
Anova(model, type=3) # type 3 sums of squares
@
